...
class MovieTest {
    ...
    @Order(2)
    void testMovieApplicationPercentDiscountPolicy(ArgumentsAccessor arguments) {
    ...
    @DisplayName("할인 정책이 없는 영화 테스트")
    @ParameterizedTest
    @CsvSource({
            "스타워즈,210,10000"
    })
    @Order(3)
    void testMovieApplicationNoneDiscountPolicy(ArgumentsAccessor arguments) {
